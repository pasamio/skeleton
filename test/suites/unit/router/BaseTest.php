...
use Grisgris\Router\Base;
use Grisgris\Input\Input;
use Grisgris\Provider\Provider;

/**
 * Test class for Grisgris\Router\Base.
 *
 * @package     Gris-Gris.Skeleton
 * @subpackage  Router
 * @since       13.1
...
class BaseTest extends TestCase
{
	...
	/**
	 * @var    Input  The Input object to be inspected for route variables.
	 * @since  13.1
	 */
	private $_input;
	 ...
	 * @return  void
	 *
	 * @covers  Grisgris\Router\Base::addMap
	 * @since   13.1
	 */
	 ...
	 * @return  void
	 *
	 * @covers  Grisgris\Router\Base::addMaps
	 * @since   13.1
	 */
	 ...
	 * @return  void
	 *
	 * @covers       Grisgris\Router\Base::parseRoute
	...
	public function testParseRoute($r, $e, $c, $i, $m)
	{
		...
		$actual = Reflection::invoke($this->_instance, 'parseRoute', $r);
	...
	protected function setUp()
	{
		...
		$this->_input = new Input($provider, array());
		$provider->set('input', $this->_input);
		$this->_instance = new Base($provider);
	}
