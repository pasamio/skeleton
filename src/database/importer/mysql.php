 ...
 * @since       13.1
 */
class ImporterMysql extends Importer
{
	/**
	 ...
	 *
	 * @return  ImporterMysql  Method supports chaining.
	 *
	 * @since   13.1
	 */
	...
	protected function mergeStructure()
	{
		...
		foreach ($xmlTables as $table)
		{
			...
			if (in_array($tableName, $tables))
			{
				...
				$queries = $this->getAlterTableSQL($xml->database->table_structure);
				if ($queries)
				{
	 ...
	 *
	 * @param   DriverMysql  $db  The database connector.
	 *
	 * @return  ImporterMysql  Method supports chaining.
	 *
	 * @since   13.1
