...
/**
 * Set is a collection class that allows the developer to operate on a set of Data objects as if they were in a
 * typical PHP array.
 *
 * @package     Gris-Gris.Skeleton
 * @subpackage  Data
...
class Set implements Exportable, ArrayAccess, Countable, Iterator, JsonSerializable
{
	...
	/**
	 * @var    array  The iterator objects.
	 * @since  13.1
	 */
	 ...
	 *
	 * @param   array  $objects  An array of  objects to bind to the data set.
	 *
	 * @since   13.1
	 ...
	 * (or values determined by custom property setters in the individual 's).
	 ...
	 * (or a value determined by custom property setters in the ).
	 *
	 * @param   string  $property  The name of the property.
	 ...
	 *
	 * This will unset all of the 'foo' properties in the list of 's.
	 *
	 * @param   string  $property  The name of the property.
	 *
	 * @return  void
	...
	public function export($depth = 3, SplObjectStorage $dumped = null)
	{
		...
		if ($depth > 0)
		{
			...
			foreach ($this->_objects as $key => $object)
			{
				$objects[$key] = $object->export($depth, $dumped);
			}
		}
	...
	{
		// Check if the object is a Data object.
