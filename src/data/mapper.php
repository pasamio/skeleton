...
abstract class Mapper
{
	 ...
	 * @param   arrat    $sort    The sorting to apply to the search.
	 * @param   integer  $offset  The pagination offset for the result set.
	 * @param   integer  $limit   The number of results to return (zero for all).
	 *
	 ...
	 * @throws  RuntimeException
	 */
	abstract protected function doFind(array $where = null, array $sort = null, $offset = 0, $limit = 0);
	 ...
	 *
	 * This method is called last in the Mapper constructor.
	 *
	 * @return  void
	 *
	 * @codeCoverageIgnore
