...
/**
 * Data is a class that is used to store data but allowing you to access the data
 ...
 * @since       13.1
 */
class Data implements Exportable, IteratorAggregate, JsonSerializable, Countable
{
	/**
	 * @var    array  The data properties.
	 * @since  13.1
	 */
	...
	{
		return new ArrayIterator($this->export(0));
	}
	 ...
	 *
	 * If recursion is set, this method will dump any object implementing JExportable (like  and Set); it will
	 * convert a DateTime object to a string; and it will convert a JRegistry to an object.
	 *
	 * @param   string            $property  The name of the data property.
	...
	protected function dumpProperty($property, $depth, SplObjectStorage $dumped)
	{
		...
		if ($depth > 0)
		{
			...
			if ($value instanceof Exportable)
			{
				...
				{
					$value = $value->export($depth - 1, $dumped);
				}
			}
