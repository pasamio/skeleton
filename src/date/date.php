...
class Date extends DateTime implements JsonSerializable
{
	...
	/**
	 * @var    DateTimeZone  Placeholder for a DateTimeZone object with the default server time zone as the time zone.
	 * @since  13.1
	 */
	protected static $stz;

	/**
	 * @var    DateTimeZone  The DateTimeZone object for usage in rending dates as strings.
	 * @since  13.1
	 */
	protected $tz;
